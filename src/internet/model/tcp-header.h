 ...
 */
   ...
   */
  uint8_t  GetEcnCount () const;

  uint8_t  GetFlags () const;
  /**
   * \return true iff the ECE bit was set
   */
  bool  GetEce () const;
  /**
   * \return true iff the CWR bit was set
   */
  bool  GetCwr () const;
  /**
...
private:
  ...
  uint8_t m_flags;      // really a uint8_t
  uint8_t m_ecncount;
  bool    m_ece;  //XXX: Hack because leaving ECE in flags breaks things
  bool    m_cwr;  //XXX: Hack because leaving CWR in flags breaks things
