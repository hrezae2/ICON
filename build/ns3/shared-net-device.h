...
#ifndef SHARED_NET_DEVICE_H
#define SHARED_NET_DEVICE_H
...
/**
 * \class SharedNetDevice
 */
class SharedNetDevice : public PointToPointNetDevice 
{
public:
  //TODO: Lets cut out multiple queues for now
  static const unsigned qCnt = 128;	// Number of queues/priorities used

  static TypeId GetTypeId (void);

  SharedNetDevice ();
  virtual ~SharedNetDevice ();
